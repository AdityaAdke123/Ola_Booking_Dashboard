...
📦 Ola-Ride-Data-Analysis-SQL  
 ┣ 📜 Ola-Ride-Data-Analysis-SQL.sql   # SQL queries for creating views  
 ┣ 📜 Ola_Booking_Dashboard.pbix       # Power BI dashboard  
 ┣ 📜 Bookings-100000-Rows.xlsx        # Cleaned dataset  
...
🚀 How to Use
SQL Queries
Import the dataset into MySQL and ensure the table structure matches.
Run Ola-Ride-Data-Analysis-SQL.sql in MySQL to create the views.
Query the views to retrieve insights.
Power BI Dashboard
Open Ola_Booking_Dashboard.pbix in Power BI.
Connect it to your dataset (if required).
Interact with the visualizations to analyze trends.
🤝 Contributing
